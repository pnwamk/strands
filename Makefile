...
# coq_makefile CoLoRBoolUtil.v CoLoREqUtil.v CoLoRListOccur.v CoLoRListRepeatFree.v CoLoRListShrink.v CoLoRListUtil.v CoLoRLogicUtil.v CoLoRNatUtil.v CoLoRPath.v CoLoRRelDec.v CoLoRRelMidex.v CoLoRRelSub.v CoLoRRelUtil.v finite_set_builder.v set_rep_equiv.v strandspacegeneric.v strandspace.v strictorder.v util.v -o Makefile 
#
